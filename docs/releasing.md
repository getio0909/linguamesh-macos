...
Before packaging, build the core XCFramework from source revision `cb061d24a3e0c4059a65d099d30bc643e9e079ea` and run all commands in `docs/testing.md`. CI pins that immutable source revision; a release must use a verified immutable artifact and checksum from the central release manifest.
