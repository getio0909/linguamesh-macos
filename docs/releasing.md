...
Before packaging, build the core XCFramework from source revision `81f04be8bff338a1df6409ba564ddca3ad0bddf3` and run all commands in `docs/testing.md`. CI pins that immutable source revision; a release must use a verified immutable artifact and checksum from the central release manifest.
